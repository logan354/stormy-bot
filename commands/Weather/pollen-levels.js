...
module.exports = {
    ...
    aliases: ["pollen", "pl"],
    category: "Weather",
    description: "Displays the current pollen levels for a specified location in New Zealand.",
    utilisation: "{prefix}pollenlevels <location>",
    ...
    async execute(client, message, args) {
        ...
        const res = await pollenLevels(location);
